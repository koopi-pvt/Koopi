  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-to-br from-indigo-50 via-white to-violet-50">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-100 rounded-full filter blur-3xl opacity-30"></div>
      </div>
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Start your journey with Koopi</p>
          </div>
